  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 p-4 backdrop-blur-[2px]">
      ...
      >
        ...
        <h3 id="delete-job-title" className="text-lg font-semibold text-slate-900">
          Delete job?
        </h3>
        <p className="mt-2 text-sm leading-6 text-slate-600">
          Are you sure you want to delete <strong className="text-slate-900">{jobTitle}</strong>? This
